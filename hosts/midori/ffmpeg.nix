...
in
{
  environment.systemPackages = [
    (unstable.ffmpeg-full.override {
      ...
      withNvcodec = true; # dynamically linked Nvidia code
      ...
      withMp3lame = false; # LAME MP3 encoder
      withMysofa = false; # HRTF support via SOFAlizer
      withNpp = true; # Nvidia Performance Primitives-based code
      ...
      withPulse = true; # Pulseaudio input support
      ...
      withSrt = false; # Secure Reliable Transport (SRT) protocol
      ...
      withWhisper = false; # Whisper speech recognition
